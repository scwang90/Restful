...
public class StackTraceUtil {
	...
	public static StackTraceElement getCurrentStatck() {
		...
		if (!stack.getClassName().equals(StackTraceUtil.class.getName())) {
			for (int i = 0; i < stacks.length; i++) {
				if (StackTraceUtil.class.getName().equals(stacks[i].getClassName())) {
					index = i;
					break;
				}
			}
	...
	public static boolean isLoopCall() {
		...
		if (!stack.getClassName().equals(StackTraceUtil.class.getName())) {
			for (int i = 0; i < stacks.length; i++) {
				if (StackTraceUtil.class.getName().equals(
